...
class BookingsModel extends FlutterFlowModel<BookingsWidget> {
  ...
  // Stores action output result for [Backend Call - API (getAllBookings)] action in DropDown widget.
  ApiCallResponse? bookingsFilteredAPIResponse;
  ...
  // Stores action output result for [Backend Call - API (getAllBookings)] action in DropDown widget.
  ApiCallResponse? mybookingsFilteredAPIResponse;
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController1(
    ...
    return controller..addPageRequestListener(listViewGetAllBookingsPage1);
  }

  void listViewGetAllBookingsPage1(ApiPagingParams nextPageMarker) =>
      listViewApiCall1!(nextPageMarker).then((listViewGetAllBookingsResponse) {
        final pageItems = (SmeGroup.getAllBookingsCall
                    .bookings(
                      listViewGetAllBookingsResponse.jsonBody,
                    )!
                    .map((e) => e)
                    .toList() ??
                [])
        ...
        listViewPagingController1?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: listViewGetAllBookingsResponse,
                )
              : null,
        );
      });
