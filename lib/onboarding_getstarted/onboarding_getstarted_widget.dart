...
import 'onboarding_getstarted_model.dart';
...
class _OnboardingGetstartedWidgetState
  ...
  late OnboardingGetstartedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingGetstartedModel());
  }
                        ...
                        children: [
                          Expanded(
                            child: FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed('ScanADocument');
                              },
                              text: 'Scan Photo ID',
