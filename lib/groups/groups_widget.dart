                            ...
                            KeepAliveWidgetWrapper(
                              builder: (context) =>
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final columnGetIndustriesResponse =
                                      snapshot.data!;
                                  return Builder(
                                    builder: (context) {
                                      final yourgroups = (SmeGroup
                                                  .getIndustriesCall
                                                  .industryName(
                                            columnGetIndustriesResponse
                                                .jsonBody,
                                          ) as List)
                                      ...
                                      return SingleChildScrollView(
                                        child: Column(
                                          mainAxisSize: MainAxisSize.max,
                                          children:
                                              List.generate(yourgroups.length,
                                                  (yourgroupsIndex) {
                                            final yourgroupsItem =
                                                yourgroups[yourgroupsIndex];
                                            return Padding(
                            ...
                            KeepAliveWidgetWrapper(
                              builder: (context) =>
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Builder(
                                    builder: (context) {
                                      final requestedgroups = (SmeGroup
                                                  .getIndustriesCall
                                                  .industryName(
                                            columnGetIndustriesResponse
                                                .jsonBody,
                                      ...
                                      return SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: List.generate(
                                              ...
                                              (requestedgroupsIndex) {
                                            final requestedgroupsItem =
                                                requestedgroups[
                                                    requestedgroupsIndex];
                                            return Padding(
                                              padding: EdgeInsetsDirectional
                            ...
                            KeepAliveWidgetWrapper(
                              builder: (context) =>
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Builder(
                                    builder: (context) {
                                      final group = (SmeGroup.getIndustriesCall
                                                  .industryName(
                                            columnGetIndustriesResponse
                                                .jsonBody,
                                          ) as List)
