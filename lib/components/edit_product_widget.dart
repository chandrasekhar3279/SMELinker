...
class _EditProductWidgetState extends State<EditProductWidget> {
  ...
  void initState() {
    ...
    _model.editProductNameController ??= TextEditingController(
        text: getJsonField(
      widget.productItem,
      r'''$.productName''',
    ).toString().toString());
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(16.0, 45.0, 16.0, 24.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                        ...
                        maxLines: null,
                        validator: _model.editProductNameControllerValidator
                            .asValidator(context),
                      ),
                      Align(
                        alignment: AlignmentDirectional(0.0, 0.0),
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            style: FlutterFlowTheme.of(context).bodyLarge,
                            maxLines: 6,
                            validator: _model.editproductDescControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.editProductPriceControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: FutureBuilder<ApiCallResponse>(
                                      future: SmeGroup.getProductCategoriesCall
                                          .call(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      _model.apiResultob6 =
                                          await SmeGroup.updateProductCall.call(
                                        accessToken: FFAppState().accessToken,
                                      ...
                                      if ((_model.apiResultob6?.succeeded ??
                                          true)) {
                                        await showDialog(
                                          context: context,
