...
import 'feed_list_shimmer_loading_model.dart';
...
class _FeedListShimmerLoadingWidgetState
    extends State<FeedListShimmerLoadingWidget> {
  late FeedListShimmerLoadingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeedListShimmerLoadingModel());
  }
