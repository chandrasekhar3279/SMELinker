...
import 'change_interest_selection_model.dart';
export 'change_interest_selection_model.dart';
...
class _ChangeInterestSelectionWidgetState
    extends State<ChangeInterestSelectionWidget> {
  late ChangeInterestSelectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangeInterestSelectionModel());
  }
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              2.0, 12.0, 0.0, 0.0),
                          child: Text(
                            '${FFAppState().dummyIndisties.length.toString()} / 5',
                            style: FlutterFlowTheme.of(context).bodyMedium,
                          ),
                        ),
                      ],
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                FFButtonWidget(
                  onPressed: !((FFAppState().dummyIndisties.length >= 1) &&
                          (FFAppState().dummyIndisties.length <= 5))
                      ? null
                      : () async {
                          setState(() {
