                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: Visibility(
                                              visible: _model.isImageUploaded ==
                                                  false,
                                              child: Text(
                                                'Tap to add an image',
                                                style:
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      FFAppState().submittedAddProductForm =
                                          true;
                                      ...
                                      if (_model.isImageUploaded == true) {
                                        _model.apiResulth0gCopyCopyCopy =
                                            await SmeGroup.createProductCall
                                                .call(
                                        ...
                                        if ((_model.apiResulth0gCopyCopyCopy
                                                ?.succeeded ??
                                            true)) {
                                          await showDialog(
                                            context: context,
